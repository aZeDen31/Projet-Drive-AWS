...
@section('title', 'Control Panel EC2')
    ...
    <div class="max-w-6xl mx-auto bg-white p-6 rounded-lg shadow-sm border border-gray-200">
        <div class="flex justify-between items-center mb-6 pb-4 border-b border-gray-200">
            <div>
                ...
                <p class="text-sm text-gray-500">Page pour lister et orchestrer les instances EC2</p>
            </div>
            <div class="flex gap-2">
                <a href="{{ route('ec2.list') }}" class="px-4 py-2 bg-orange-600 text-white rounded-xl hover:bg-orange-700 text-sm font-semibold transition-all">
                    Actualiser
                </a>
            </div>
        </div>
